package main.java.com.udemy.ltp.java_dev_bootcamp.module_2_oop.sections.sec_25_enums.model;
...
public class Car {
	...
	public void drive(/*String trafficLight*/ TrafficLight trafficLight) {
		/*
		if(
			!trafficLight.equals("RED") &&
			!trafficLight.equals("GREEN") &&
